...
**Quick path:** new to the API? Go from an API key to your first successful call in the [Quickstart](/introduction/quickstart) (~5 minutes), then come back here for the approval workflow.

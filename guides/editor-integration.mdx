...
<Note>
  This guide covers **attribute preservation**. For rendering inline diff overlays inside the editor, see [Human-in-the-Loop → Rendering diffs inline in your editor](/guides/human-in-the-loop#rendering-diffs-inline-in-your-editor). For streaming events, see [SSE Streaming](/guides/streaming).
</Note>

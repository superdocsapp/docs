...
If your AI agent supports MCP (like Claude), connect it directly to SuperDocs. See [MCP Integration](/mcp/setup) for setup. The AI agent gets native access to all 35 SuperDocs tools — including `revert_session_to_message` — without writing any API client code.

...
### Multi-language editing (16+ languages)

Edit documents in English, Spanish, French, German, Mandarin, Japanese, Hindi, Hebrew, Arabic, Portuguese, Russian, Italian, Korean, Dutch, Polish, and Turkish. Natural-language instructions work in any of them — write your prompt in Hindi, edit a document in Spanish, get the AI's reply in whatever language you wrote the request in. Multilingual documents (e.g., bilingual contracts) handled correctly. Tone and formality conventions adapted per language.
...
Restore documents to any prior state and browse a timeline of every edit. Useful for **"oops, undo that"** moments, compliance audits, and exploring alternate editing paths without losing the current version. Audit trail of who edited what, when. Targeted to ship within the next 2-4 weeks.

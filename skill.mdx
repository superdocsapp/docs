...
Restart Claude Code. The 35 SuperDocs tools become available; this skill auto-loads when document work is requested.
...
## Tool reference (35 tools — full descriptions in `available-tools.mdx`)

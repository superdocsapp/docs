...
Restart Claude Code. The 22 SuperDocs tools become available; this skill auto-loads when document work is requested.
...
## Tool reference (25 tools — full descriptions in `available-tools.mdx`)

...
The returned HTML contains `data-chunk-id` attributes on elements. These enable the AI to make targeted edits to specific sections without reprocessing the entire document.
